...
<div class="herder" style="font-size: 18px;margin-top: 33px;padding-left: 65px;";>
    FROM OUR GALLERY
</div>
<div class="container" style="margin-top: 21px" ;>
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="item"><img style="max-width: 105%;" class="a" src="./images/service-img-3.jpg" alt="" srcset=""></div>
        </div>
        <div class="col-md-4">
