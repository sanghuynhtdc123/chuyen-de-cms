    ...
    <div class="module-4__row">
        <div class="module-4__row-item">
            <div class="module-4__row-item-content">
                <h3 class="module-4__row-item-heading">PAROS & IOS SUN</h3>
      ...
      <div class="row three-part">
        ...
        <div class="module-4__row-item">
            <div class="module-4__row-item-images">
                <img id="image" src="./images/p2-img-6 (1).jpg" alt="The-image-has-2-men-surfing-on-the-sea" class="module-4__row-item-img">
