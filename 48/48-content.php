    ...
    <div class="module-4__row">
        ...
        <div class="module-4__row-item">
            <div class="module-4__row-item-images">
                <img id="image" src="./images/p2-img-7-2.jpg" alt="The-image-has-2-men-surfing-on-the-sea" class="module-4__row-item-img">
        ...
        <div class="module-4__row-item">
            <div class="module-4__row-item-content">
                <h3 class="module-4__row-item-heading">SANTORINI SAND</h3>
